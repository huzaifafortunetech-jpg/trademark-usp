<header class="main-nav-header">
    <div class="main-nav-wrapper">
        ...
        <a href="<?php echo e(route('home')); ?>" class="main-nav-logo">
            <img src="<?php echo e(asset('imagees/logo-new-BIG.png')); ?>" alt="Trademark USP Logo" class="main-nav-logo-image">
        </a>
        ...
        <nav class="main-nav-links-container">
            <ul class="main-nav-list">
                    ...
                    <div class="main-nav-dropdown-content">
                        <div class="main-nav-dropdown-services">
                            ...
                            <ul class="main-nav-dropdown-list main-nav-col-left">
                                ...
                                <li><a href="<?php echo e(route('trademark-renewal')); ?>">Trademark Renewal</a></li>
                                <li><a href="<?php echo e(route('office-action')); ?>">Office Action Response</a></li>
                                <li><a href="<?php echo e(route('statement-of-use-extension')); ?>">Filing an Extension</a></li>
                            </ul>
                            <ul class="main-nav-dropdown-list main-nav-col-right">
                                <li><a href="<?php echo e(route('comprehensive-search')); ?>">Comprehensive Trademark Search</a></li>
                                ...
                                <li><a href="<?php echo e(route('statement-of-use')); ?>">Statement of Use</a></li>
                                <li><a href="<?php echo e(route('dmca-takedown-service')); ?>">DMCA Takedown </a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                ...
                <li class="main-nav-item main-nav-dropdown">
                    ...
                    <div class="main-nav-dropdown-content">
                        <div class="main-nav-dropdown-services">
                            ...
                            <ul class="main-nav-dropdown-list main-nav-col-right">
                                <li><a href="<?php echo e(route('trademark-faqs')); ?>">Trademark FAQS</a></li>
                                <li><a href="<?php echo e(route('copyrights-faqs')); ?>">Copyright FAQS</a></li>
                ...
                <li class="main-nav-item">
                    <a href="<?php echo e(route('about-us')); ?>" class="main-nav-link">About us</a>
                </li>
            </ul>
            ...
            <div class="main-nav-cta-group mobile-only-ctas">
                ...
                <a href="<?php echo e(route('login')); ?>" class="second-nav-button primary-cta">Login</a>
            </div>
...
<div class="right-ribbon-container">
    ...
    <div class="hover-area hover-form vertical" id="ribbonForm">
        ...
        <div class="ribbon-expanded">
            ...
            <a href="<?php echo e(route('home')); ?>" class="main-nav-logo">
                <img src="<?php echo e(asset('imagees/logo-new-BIG.png')); ?>" alt="Trademark USP Logo" class="main-nav-logo-image form-logo">
            </a>

            <h4>Free Legal Consultation</h4>

            <form method="POST" action="<?php echo e(route('modal.form.submit')); ?>" id="ribbonFormForm">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    form.addEventListener("submit", function (e) {
        ...
        grecaptcha.ready(function () {
            grecaptcha.execute('<?php echo e(env("NOCAPTCHA_SITEKEY")); ?>', { action: 'ribbon_form' })
            .then(function (token) {
...
<!-- </div> --><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/partials/header.blade.php ENDPATH**/ ?>