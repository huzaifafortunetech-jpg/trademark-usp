        ...
        <aside class="blog-layout-sidebar">
            ...
            <div class="blog-sidebar-categories">
                ...
                <ul class="blog-sidebar-list">
                    ...
                    <li><a href="<?php echo e(route('b-copyright')); ?>" class="blog-sidebar-category-link ">Copyrights</a></li>
                    <li><a href="<?php echo e(route('b-guides')); ?>" class="blog-sidebar-category-link ">Guides</a></li>
                    <li><a href="<?php echo e(route('b-trademark')); ?>" class="blog-sidebar-category-link is-active">Trademarks</a></li>
                </ul>
            </div>
            ...
            <div class="blog-content-list">
                ...
                <div class="blog-card-item">
                    ...
                    <div class="blog-card-info">
                        ...
                        <a href="<?php echo e(route('blog-page8')); ?>" class="blog-card-read-more">Read More &rarr;</a>
                    </div>
                </div>
                ...
                <div class="blog-card-item">
                    ...
                    <div class="blog-card-info">
                        ...
                        <a href="<?php echo e(route('blog-page9')); ?>" class="blog-card-read-more">Read More &rarr;</a>  
                    </div>
                </div>
                  <div class="blog-card-item">
                    <div class="blog-card-image-container">
                    ...
                    <div class="blog-card-info">
                        ...
                        <a href="<?php echo e(route('blog-page7')); ?>" class="blog-card-read-more">Read More →</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/b-trademark.blade.php ENDPATH**/ ?>