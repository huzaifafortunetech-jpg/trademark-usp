<div
    class="tm-wizard-wrapper step-<?php echo e($step); ?>"
    x-data="{ selected: <?php if ((object) ('trademark_type') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('trademark_type'->value()); ?>')<?php echo e('trademark_type'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('trademark_type'); ?>')<?php endif; ?>.live }"
    ...
    >
        ...
        <!-- Center image (static) -->
        <img
            src="<?php echo e(asset('imagees/Icon-new-BIG.webp')); ?>"
                ...
                <button type="button"
                    ...
                    <div class="tm-option-row">
                        ...
                        <div class="tm-selected-text">
                            <img src="<?php echo e(asset('imagees/amazon-logo.webp')); ?>" alt="Logo">
                        </div>
                    </div>
                </button>
            </div>
    
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['trademark_type'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 2): ?>
        <!--LEFT SIDE -->
        <div class="tm-left">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trademark_type === 'name'): ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trademark_type === 'slogan'): ?>
                <h1>Slogan Protection</h1>
                <p>Enter the slogan you want to secure for your brand</p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trademark_type === 'logo'): ?>
         ...
         <!--RIGHT SIDE -->
        <div class="tm-right">
            <h2>Enter the <?php echo e(ucfirst($trademark_type ?? 'Trademark')); ?> you want to protect</h2>
            ...
            <input
                ...
                placeholder="e.g. Adidas <?php echo e(ucfirst($trademark_type)); ?>">
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 4): ?>
        ...
        <div class="tm-right">
            ...
            <div class="pricing-container">
                ...
                <div class="pricing-card basic-package one <?php echo e($plan === 'basic' ? 'active' : ''); ?>">
                    <div class="card-header">
                        <h3>Basic Package</h3>
                        <p class="tagline">I only need what it takes to file</p>
    
                        <div class="price-block">
                            <span class="price-value">$<?php echo e($plans['basic']); ?></span>
                ...
                <div class="pricing-card standard-package two <?php echo e($plan === 'standard' ? 'active' : ''); ?>">
                    <div class="card-header">
                        <h3>Standard Package</h3>
                        <p class="tagline">Enhanced and thorough process</p>
    
                        <div class="price-block">
                            <span class="price-value">$<?php echo e($plans['standard']); ?></span>
                            <p class="fees">+ applicable fees</p>
                        </div>
                ...
                <div class="pricing-card premium-package highlight-card three <?php echo e($plan === 'premium' ? 'active' : ''); ?>">
                    <div class="card-header">
                        <h3>Premium Package</h3>
                        <p class="tagline">Premium legal support</p>
    
                        <div class="price-block">
                            <span class="price-value">$<?php echo e($plans['premium']); ?></span>
                            <p class="fees">+ applicable fees</p>
                        </div>
        ...
        <div class="tm-right">
            ...
            <div class="plans-container">
                ...
                <div class="plans-grid">
                    ...
                    <div
                        class="plan-card <?php echo e(in_array('basic', $addons ?? []) ? 'active' : ''); ?>"
                        ...
                        <div class="card-bottom-content">
                            ...
                            <button type="button" class="plan-btn">
                                <?php echo e(in_array('basic', $addons) ? 'Selected' : 'Continue with Basic'); ?>
                    ...
                    <div
                        class="plan-card popular <?php echo e(in_array('standard', $addons ?? []) ? 'active' : ''); ?>"
                        ...
                        <div class="card-bottom-content">
                            <button type="button" class="plan-btn">
                                <?php echo e(in_array('standard', $addons) ? 'Selected' : 'Continue with Standard'); ?>
                ...
                <div
                    class="plan-card premium <?php echo e(in_array('premium', $addons ?? []) ? 'active' : ''); ?>"
                    ...
                    <div class="card-bottom-content">
                        ...
                        <button type="button" class="plan-btn">
                            <?php echo e(in_array('premium', $addons) ? 'Selected' : 'Continue with Premium'); ?>
        ...
        <div class="tm-right">
            ...
            <div class="plans-container">
                <div class="plans-grid">
                    ...
                    <div
                        class="plan-card <?php echo e($priority === 'standard' ? 'active' : ''); ?>"
                        ...
                        <div class="card-bottom-content">
                            ...
                            <button
                                ...
                                <?php echo e($priority === 'standard' ? 'Selected' : 'Continue with Standard'); ?>
                    ...
                    <div
                        class="plan-card popular <?php echo e($priority === 'express' ? 'active' : ''); ?>"
                        ...
                        <div class="card-bottom-content">
                            ...
                            <button
                                ...
                                <?php echo e($priority === 'express' ? 'Selected' : 'Continue with Express'); ?>
                ...
                <div
                    class="plan-card premium <?php echo e($priority === 'priority' ? 'active' : ''); ?>"
                    ...
                    <div class="card-bottom-content">
                        ...
                        <button
                            ...
                            <?php echo e($priority === 'priority' ? 'Selected' : 'Continue with Priority'); ?>
            ...
            <div class="order-summary">
                ...
                <div class="order-item">
                    <div class="item-left">
                        ...
                        <p class="item-title">
                            Trademark Registration – <?php echo e(ucfirst($plan)); ?> Package
                        </p>
                    </div>
                    <div class="item-price">$<?php echo e($plan_price); ?></div>
                </div>
    
                
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $addons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div class="order-item">
                    <div class="item-left">
                        ...
                        <p class="item-title">
                            <?php echo e($addonLabels[$a] ?? ucfirst($a)); ?>

                        </p>
                    </div>
    
                    <div class="item-price">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($addonList[$a] ?? 0) > 0): ?>
                        $<?php echo e($addonList[$a]); ?>
                ...
                <div class="order-item">
                    <div class="item-left">
                        ...
                        <p class="item-title">
                            <?php echo e(ucfirst($priority)); ?> Processing
                        </p>
                    </div>
                    <div class="item-price">$<?php echo e($priority_price); ?></div>
                </div>
                ...
                <div class="promo-message <?php echo e($promoSuccess ? 'success' : 'error'); ?>">
                    <?php echo e($promoMessage); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['sms_consent'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="tm-error"><?php echo e($message); ?></span> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPlanModal): ?>
            <div class="tm-modal-overlay">
                <div class="tm-modal" style="position:relative"
                    x-data="{ selected: <?php if ((object) ('tempPlan') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempPlan'->value()); ?>')<?php echo e('tempPlan'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempPlan'); ?>')<?php endif; ?> }">
    
                    <span class="modal-close" wire:click="closeModal">&times;</span>
    
                    <h3>Trademark Packages</h3>
    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div
                        class="option-card"
                        :class="{ 'active': selected === '<?php echo e($key); ?>' }"
                        @click="selected='<?php echo e($key); ?>'">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showAddonModal): ?>
            <div class="tm-modal-overlay">
                <div class="tm-modal" style="position:relative"
                    x-data="{ selected: <?php if ((object) ('tempAddon') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempAddon'->value()); ?>')<?php echo e('tempAddon'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempAddon'); ?>')<?php endif; ?> }">
    
                    <span class="modal-close" wire:click="closeModal">&times;</span>
    
                    <h3>Search Package</h3>
    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $addonList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div
                        class="option-card"
                        :class="{ 'active': selected === '<?php echo e($key); ?>' }"
                        @click="selected='<?php echo e($key); ?>'">
                        ...
                        <span><?php echo e($price == 0 ? 'Free' : '$'.$price); ?></span>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPriorityModal): ?>
            <div class="tm-modal-overlay">
                <div class="tm-modal" style="position:relative"
                    x-data="{ selected: <?php if ((object) ('tempPriority') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempPriority'->value()); ?>')<?php echo e('tempPriority'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('tempPriority'); ?>')<?php endif; ?> }">
    
                    <span class="modal-close" wire:click="closeModal">&times;</span>
    
                    <h3>Processing Speed</h3>
    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <div
                        class="option-card"
                        :class="{ 'active': selected === '<?php echo e($key); ?>' }"
                        @click="selected='<?php echo e($key); ?>'">
...
<?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/livewire/trademark-wizard.blade.php ENDPATH**/ ?>