...
<div class="error-card">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-3">
        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-brand">
            Go to Sign in
        </a>

        <a href="<?php echo e(route('home')); ?>" class="btn btn-brand ms-2">
            Go to Home
        </a>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/errors/403.blade.php ENDPATH**/ ?>