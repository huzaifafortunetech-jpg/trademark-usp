...
<?php $__env->startSection('title', 'Statement Of Use - Trademark USP'); ?>
    ...
    <div class="accordion-container">
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-content" id="content-44" hidden>
                ...
                <p>The USPTO generally allows applicants to file up to five six-month extensions. <a href="<?php echo e(route('privacy-policy')); ?>">Click here</a> to read more about Trademark USP’s extension services.</p>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/statement-of-use.blade.php ENDPATH**/ ?>