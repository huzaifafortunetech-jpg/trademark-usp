...
<?php $__env->startSection('title', 'About Us - Trademark USP'); ?>
    ...
    <div class="renewal-products-wrapper">
        ...
        <div class="renewal-products-header">
            ...
            <div class="renewal-products-cta-group">
                ...
                <a href="<?php echo e(route('trademark-search')); ?>" class="renewal-products-link-secondary">Free Trademark Search ></a>
            </div>
        </div>
        ...
        <div class="renewal-products-grid">
            ...
            <div class="renewal-products-card">
                ...
                <a href="<?php echo e(route('comprehensive-search')); ?>" class="renewal-products-read-more">Read More <span class="arrow">></span></a>
            </div>
            ...
            <div class="renewal-products-card">
                ...
                <a href="<?php echo e(route('trademark-renewal')); ?>" class="renewal-products-read-more">Read More <span class="arrow">></span></a>
            </div>
            ...
            <div class="renewal-products-card">
                ...
                <a href="<?php echo e(route('dmca-takedown-service')); ?>" class="renewal-products-read-more">Read More <span class="arrow">></span></a>
            </div>
            ...
            <div class="renewal-products-card">
                ...
                <a href="<?php echo e(route('statement-of-use-extension')); ?>" class="renewal-products-read-more">Read More <span class="arrow">></span></a>
            </div>
...
<?php echo $__env->make('sections.cta-section', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\trademark-usp\resources\views/about-us.blade.php ENDPATH**/ ?>