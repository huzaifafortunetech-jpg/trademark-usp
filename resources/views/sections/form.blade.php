    ...
    <div id="fcmp-modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('modal.form.submit') }}" id="modalForm">
                    @csrf
...
//             grecaptcha.execute('{{ env("NOCAPTCHA_SITEKEY") }}', {action: 'modal_form'}).then(function(token) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener("submit", function (e) {
        ...
        grecaptcha.ready(function () {
            grecaptcha.execute('{{ env("NOCAPTCHA_SITEKEY") }}', { action: 'modal_form' })
            .then(function (token) {
                document.getElementById("g-recaptcha-response").value = token;
...
<!--    <script>console.log(@json(auth()->check()));</script>-->
...
<!--            </div>-->
<!--            <div class="modal-body">-->
<!--                <form method="POST" action="{{ route('modal.form.submit') }}">-->
<!--                    @csrf-->
<!--                    <div class="fld-input">-->
