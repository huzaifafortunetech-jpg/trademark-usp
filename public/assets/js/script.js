$(document).ready(function () {
    ...
    if ($('.datanew').length > 0 && !$.fn.DataTable.isDataTable('.datanew')) {
        $('.datanew').DataTable({
            bFilter: true,
            sDom: 'fBtlpi',
            pagingType: 'numbers',
    ...
    $(document).ready(function () {
        ...
        // Sidebar mouseover for mini-sidebar expand
        // $(document).on('mouseover', function (e) {
        //     if ($body.hasClass('mini-sidebar') && $toggleBtn.is(':visible')) {
        ...
        // Optional: restore mini-sidebar state from localStorage
